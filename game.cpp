...
Game::Game()
{
    ...
    borderOuter->setBrush(QBrush(QColor::fromRgb(85, 125, 137)));
    borderInner->setRect(50,50,640,640);
    borderInner->setPen(QPen(QColor::fromRgb(137, 97, 85)));
    borderInner->setBrush(QBrush(QColor::fromRgb(137, 97, 85)));
